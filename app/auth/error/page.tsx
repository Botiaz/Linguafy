...
export default function AuthErrorPage() {
  return (
    <div className="min-h-screen bg-background bg-[radial-gradient(900px_420px_at_50%_0%,hsl(var(--destructive)/0.12),transparent_72%)] flex items-center justify-center p-4 md:p-6 animate-in fade-in duration-200">
